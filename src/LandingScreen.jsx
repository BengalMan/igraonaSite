...
function LandingScreen() {
    ...
    return (
        <div className="w-screen h-screen font-RS">
            ...
            <div className="w-full h-full bg-slate-800 relative overflow-hidden flex justify-center">
                <video
                    src={Video}
                    type="video/mp4"
                    loop
            ...
            <div className="bg-black w-[120%] h-[70vh] border-t-[4rem] border-b-[4rem] border-gradient flex justify-center items-center relative bottom-16 z-10 transform rotate-[-3deg] origin-top -left-[10%]">
